...
optimizer_factory = with_optimizer(CPLEX.Optimizer, CPX_PARAM_DEPIND = 3, CPXPARAM_MIP_Cuts_LiftProj = 3, CPX_PARAM_MIPEMPHASIS=CPLEX.CPX_MIPEMPHASIS_FEASIBILITY)#CPX_PARAM_MIPEMPHASIS=CPLEX.CPX_MIPEMPHASIS_HIDDENFEAS)#CPX_PARAM_DEPIND=3, CPXPARAM_MIP_Cuts_LiftProj=3)#CPX_PARAM_MIQCPSTRAT=1)
